...
- **DB**: PostgreSQL 16 + pgvector, SQLAlchemy 2 async (`asyncpg`), Alembic (43 linear migrations, single head)
...
- Alembic history is **linear, single-head, append-only** (`0001` … `0043`).
